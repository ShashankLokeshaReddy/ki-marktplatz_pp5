...
class ShiftModel:
    ...
    def __init__(self, current_shift_time, shift_model):
        ...
        self.shifts = {
            "FLEX": {
                0: [
                    [datetime.time(6, 0), datetime.time(12, 30)],
            ...
            "FLEXS": {
                ...
                4: [
                    [datetime.time(14, 0), datetime.time(19, 0)],
            ...
            "W01S1": {
                0: [
                    [datetime.time(6, 0), datetime.time(14, 5)],
                ...
                4: [
                    [datetime.time(6, 0), datetime.time(11, 25)],
            ...
            "W01S3": {
                0: [[datetime.time(6, 0), datetime.time(23, 55)]],
            ...
            "W01YL": {
                0: [[datetime.time(6, 0), datetime.time(21, 45)]],
            ...
            "W011": {
                0: [
                    ...
                    [datetime.time(9, 15), datetime.time(12, 30)],
    ...
    def get_earliest_time(self, start: datetime.datetime) -> datetime.datetime:
        ...
        for interval in self.shifts[self.shift_model][weekday]:
            if interval[0] <= start.time() < interval[1]:
                ...
                return start.replace(hour=interval[0].hour, minute=interval[0].minute)
