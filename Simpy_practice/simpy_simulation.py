...
def main(job_list):
    ...
    ml2 = ManufacturingLayer()

    pp = ProductionPlant()
    pp.add_manufacturing_layer(ml1)
    pp.add_manufacturing_layer(ml2)
    ...
    for i, manufacturing_layer in enumerate(pp.manufacturing_layers):
        ...
        mg4 = MachineGroup(env, "group1")
        mg4.add_machine(m10)
        mg4.add_machine(m11)

        mg5 = MachineGroup(env, "group2")
        mg5.add_machine(m12)

        mg6 = MachineGroup(env, "group3")
        mg6.add_machine(m13)

        ml2.add_machine_group(mg4)
        ml2.add_machine_group(mg5)
        ml2.add_machine_group(mg6)
        ...
        for job in job_list:
            job["resourceId"] = ""
            job["jobInputDate"] = job["productionEnd"]
            job["productionStart"] = ""
            job["productionEnd"] = ""      
            job["jobStartDelay"] = ""
            job["jobEndDelay"] = ""
