...
export default {
  ...
  methods: {
    saveJobs() {
      ...
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/savejobstoCSV/')
        .then((response) => {
    ...
    fillTable() {
      ...
      const saveButtonRenderer = params => {
        ...
        button.addEventListener('click', () => {
          ...
          axios.post('http://' + window.location.hostname + ':8000/api/jobs/setInd_Table/', formData)
          .then(response => {
              console.log(response.data);
          })
          .catch(error => {
      ...
      fetch('http://' + window.location.hostname + ':8000/api/jobs/getSchedule')
        .then((res) => res.json())
    ...
    runGeneticOptimizer() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/run_genetic_optimizer/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    runSJF() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/run_sjf/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    runLJF() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/run_ljf/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    runDeadlineFirst() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/run_deadline_first/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    runReleaseFirst() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/run_release_first/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    runRandom() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/run_random/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    deleteJobs() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/deleteJobs/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          window.alert(response.data.message);
    ...
    stopProcess() {
      axios
        .post('http://' + window.location.hostname + ':8000/api/jobs/stop_genetic_optimizer/')
        .then((response) => {
          console.log(response.data);
          this.fillTable();
        })
    ...
    upload() {
      ...
      this.isLoading = true;
      axios.post('http://' + window.location.hostname + ':8000/api/jobs/uploadCSV/', formData)
        .then(response => {
          console.log(response.data);
          this.isLoading = false;
          window.alert(response.data.message);
